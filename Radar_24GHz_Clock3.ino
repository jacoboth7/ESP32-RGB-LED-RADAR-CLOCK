...
void DigitalClock() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (unix_epoch != _Epoch) {  //Serial.print("ChangedToIdle"); // Serial.println(ChangedToIdle);
      ...
      // else
      // {
      //   ChangedToIdle = false;  //display.showBuffer();              // epoch changes every miliseconds, we only want to draw when digits actually change.
      //   if (Second != _Second) {
      ...
      //     int s1 = Second / 10;
      //     if (s0 != digit0.Value()) {
      //      digit0.Draw(s0); // digit0.Morph(s0);
      //       // display.showBuffer();
      //     }
      //     if (s1 != digit1.Value()) {
      //       digit0.Draw(s1); //digit1.Morph(s1);
      //       // display.showBuffer();
      //     }
      //     display.showBuffer();
      //     _Second = Second;
      ...
      //     int m1 = Minute / 10;
      //     if (m0 != digit2.Value()) {
      //       digit2.Draw(m0); //digit2.Morph(m0);
      //      // display.showBuffer();
      //     }
      //     if (m1 != digit3.Value()) {
      //        digit3.Draw(m1); //digit3.Morph(m1);
      //       // display.showBuffer();
      //     }
      //     display.showBuffer();
      //     _Minute = Minute;
      ...
      //     int h1 = Hour / 10;
      //     if (h0 != digit4.Value()) {
      //       digit4.Draw(h0); //digit4.Morph(h0);
      //       // display.showBuffer();
      //     }
      //     if (h1 > 0) {
      //       if (h1 != digit5.Value()) {
      //         digit5.Draw(h1); //digit5.Morph(h1);
      //         //display.showBuffer();
      //       }
      //     }
      //     _Hour = Hour;
